...
export default function Landing() {
  ...
  const languages = [
    ...
    { icon: <CPlusplus size={40} />, name: "C++" },
    { icon: <Python size={40} />, name: "Python" },
    { icon: <Javascript size={40} />, name: "JavaScript" },
    { icon: <Java size={40} />, name: "Java" },
    ...
    <div className="landing-page">
      ...
      <section className="section-about fade-in" id="nosotros">
        ...
        <div className="about-icons" id='acerca-de'>
          <div className="about-icon-card"><Python size={60} /></div>
          <div className="about-icon-card"><Javascript size={60} /></div>
          <div className="about-icon-card center-card">
            <CodeAlt size='xl'/>
          </div>
          <div className="about-icon-card"><Java size={60} /></div>
          <div className="about-icon-card"><C size={60} /></div>
          <div className="about-icon-card"><CPlusplus size={60} /></div>
        </div>
      </section>
      ...
      <section className="section-how fade-in" id="caracteristicas">
        ...
        <div className="steps-grid">
          <div className="step-card">
            ...
            <p>Cada módulo explica un concepto de forma sencilla, con ejemplos claros.</p>
          </div>
      ...
      <section className="section-langs fade-in" id="lenguajes">
        ...
        <div className="langs-carousel">
          <div className="langs-grid">
            {[...languages, ...languages].map((lang, index) => (
              <div key={index} className="langs-grid-chip">
                {lang.icon}
                {lang.name}
              </div>
            ))}
        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              <a className="social-link" href="https://github.com/LewisAngelo11/Programademy" aria-label="GitHub">
