...
export type GetOpcionAggregateType<T extends OpcionAggregateArgs> = {
    [P in keyof T & keyof AggregateOpcion]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateOpcion[P]> : Prisma.GetScalarType<T[P], AggregateOpcion[P]>;
};
...
type GetOpcionGroupByPayload<T extends opcionGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<OpcionGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof OpcionGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], OpcionGroupByOutputType[P]> : Prisma.GetScalarType<T[P], OpcionGroupByOutputType[P]>;
}>>;
...
export type opcionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<opcionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface opcionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['opcion'];
        meta: {
            name: 'opcion';
        };
    };
     ...
     * })
    **/
    count<T extends opcionCountArgs>(args?: Prisma.Subset<T, opcionCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], OpcionCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends opcionGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, opcionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOpcionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export {};
//# sourceMappingURL=opcion.d.ts.map