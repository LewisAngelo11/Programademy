...
export type GetPreguntaAggregateType<T extends PreguntaAggregateArgs> = {
    [P in keyof T & keyof AggregatePregunta]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregatePregunta[P]> : Prisma.GetScalarType<T[P], AggregatePregunta[P]>;
};
...
type GetPreguntaGroupByPayload<T extends preguntaGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<PreguntaGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof PreguntaGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], PreguntaGroupByOutputType[P]> : Prisma.GetScalarType<T[P], PreguntaGroupByOutputType[P]>;
}>>;
...
export type preguntaCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<preguntaFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface preguntaDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['pregunta'];
        meta: {
            name: 'pregunta';
        };
    };
     ...
     * })
    **/
    count<T extends preguntaCountArgs>(args?: Prisma.Subset<T, preguntaCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], PreguntaCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends preguntaGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, preguntaGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPreguntaGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export {};
//# sourceMappingURL=pregunta.d.ts.map