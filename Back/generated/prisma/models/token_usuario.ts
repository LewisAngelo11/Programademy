...
// @ts-nocheck 
/*
 * This file exports the `token_usuario` model and its related types.
 *
...
export type GetToken_usuarioAggregateType<T extends Token_usuarioAggregateArgs> = {
      [P in keyof T & keyof AggregateToken_usuario]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateToken_usuario[P]>
    : Prisma.GetScalarType<T[P], AggregateToken_usuario[P]>
}
...
type GetToken_usuarioGroupByPayload<T extends token_usuarioGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Token_usuarioGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Token_usuarioGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Token_usuarioGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Token_usuarioGroupByOutputType[P]>
      }
    >
  >
...
export type token_usuarioCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<token_usuarioFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface token_usuarioDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['token_usuario'], meta: { name: 'token_usuario' } }
  /**
   ...
   * })
  **/
  count<T extends token_usuarioCountArgs>(
    args?: Prisma.Subset<T, token_usuarioCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Token_usuarioCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends token_usuarioGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, token_usuarioGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetToken_usuarioGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
