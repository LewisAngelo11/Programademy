...
// @ts-nocheck 
/*
 * This file exports the `modulo_completado` model and its related types.
 *
...
export type GetModulo_completadoAggregateType<T extends Modulo_completadoAggregateArgs> = {
      [P in keyof T & keyof AggregateModulo_completado]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateModulo_completado[P]>
    : Prisma.GetScalarType<T[P], AggregateModulo_completado[P]>
}
...
type GetModulo_completadoGroupByPayload<T extends modulo_completadoGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Modulo_completadoGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Modulo_completadoGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Modulo_completadoGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Modulo_completadoGroupByOutputType[P]>
      }
    >
  >
...
export type modulo_completadoCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<modulo_completadoFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface modulo_completadoDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['modulo_completado'], meta: { name: 'modulo_completado' } }
  /**
   ...
   * })
  **/
  count<T extends modulo_completadoCountArgs>(
    args?: Prisma.Subset<T, modulo_completadoCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Modulo_completadoCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends modulo_completadoGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, modulo_completadoGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetModulo_completadoGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
